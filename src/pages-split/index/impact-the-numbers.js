...
class ImpactTheNumbersIndexPageSplit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modalStatus: false,
          ...
          <div className="container">
            ...
            <div className={styles.blockFilterDivider}>
              ...
              <div className={styles.blockFilterDividerItem}>
                ...
                <div className={styles.blockFilterDividerItemBottom} onClick={() => this.setState({ modalVideoTitle: "Case Study: Alorica", modalVideoID: "ciSB3gMpH_g" })}>
                  <a onClick={this.openModal} className="global-button text-lowercase">Case Study:<br />Alorica</a>
                </div>
              </div>
              ...
              <div className={styles.blockFilterDividerItem}>
                ...
                <div className={styles.blockFilterDividerItemBottom} onClick={() => this.setState({ modalVideoTitle: "Case Study: Genpact", modalVideoID: "aXTAjF8T-Kg" })}>
                  <a onClick={this.openModal} className="global-button text-lowercase">Case Study:<br />Genpact</a>
                </div>
              </div>
              ...
              <div className={styles.blockFilterDividerItem}>
                ...
                <div className={styles.blockFilterDividerItemBottom} onClick={() => this.setState({ modalVideoTitle: "Case Study: Starwood", modalVideoID: "nFRDqo_rc3o" })}>
                  <a onClick={this.openModal} className="global-button text-lowercase">Case Study:<br />Starwood</a>
                </div>
              </div>
              ...
              <div className={styles.blockFilterDividerItem}>
                ...
                <div className={styles.blockFilterDividerItemBottom}>
                  <Link to="/our-style" className="global-button text-lowercase">More about<br />Talkpush</Link>
                </div>
              </div>
